    ...
    async def sync_models(
        ...
        for item in upstream_items:
            ...
            if model_id in existing_map:
                ...
                if pm.output_price_per_million == 0 and output_fen > 0:
                    pm.output_price_per_million = output_fen
                ...
                pm = PoolModel(
                    ...
                    input_price_per_million=input_fen,
                    output_price_per_million=output_fen,
                )
                model_repo.add(pm)
