...
from content_service.api import api_router
from content_service.config import settings
from content_service.models import SERVICE_MODELS
...
from content_service.db import close_db, create_engine, get_engine, init_db, init_session_factory
...
async def lifespan(app: FastAPI):
    """Initialize content infrastructure."""
    del app
...
async def root():
    ...
    return {
        "message": "Eucal AI Content Service",
        "version": settings.VERSION,
