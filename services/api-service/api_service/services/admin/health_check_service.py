...
- `from services.pool_service import _extract_balance` →
  `from api_service.services.admin.pool_service import _extract_balance`
- `from common.utils.crypto import decrypt_api_key` →
  `from api_service.common.security.crypto import decrypt_api_key`
- `from common.redis import get_redis` →
  `from api_service.common.infra.redis import get_redis`

CONTEXT O-2/O-5 + plan architectural note: this service is invoked by an
ARQ cron job registered in `api_service/core/jobs.py`. The cron cadence
