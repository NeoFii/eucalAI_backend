...
import that uses a flat package prefix is rewritten to the api_service
...
land under their new api_service paths (see the matching imports below).
...
from api_service.common.security.token_blacklist import (
    blacklist_token,
