...
- Import paths rewritten to api_service.*
- require_super_admin from api_service.core.policies
"""
# ruff: noqa: B008
...
from api_service.schemas.admin.service_logs import (
    ServiceLogEntry,
    ServiceLogResult,
    ServiceLogsResponseData,
)
from api_service.services.admin.service_logs_service import AdminServiceLogsService
