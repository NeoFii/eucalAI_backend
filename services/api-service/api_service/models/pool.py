"""Pool management models: Pool, PoolModelConfig, PoolAccount."""
...
class Pool(SnowflakeIdMixin, TimestampMixin, Base):
    ...
    models = relationship(
        "PoolModelConfig", back_populates="pool", lazy="selectin", cascade="all, delete-orphan",
    )
...
class PoolModelConfig(SnowflakeIdMixin, TimestampMixin, Base):
