...
class ModelCatalog(Base, SnowflakeIdMixin, TimestampMixin):
    ...
    category_links = relationship(
        ...
        lazy="selectin",
        cascade="all, delete-orphan",
        order_by="ModelCatalogCategoryMap.sort_order",
    )


class ModelCatalogCategoryMap(Base, SnowflakeIdMixin, TimestampMixin):
    ...
    model = relationship("ModelCatalog", back_populates="category_links", lazy="noload")
