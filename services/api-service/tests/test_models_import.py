...
def test_no_circular_import():
    """Importing api_service.models should not raise any errors."""
...
def test_model_tablename(class_name: str, tablename: str):
    ...
    import api_service.models as models
...
def test_all_models_importable():
    """All 20 model classes can be imported from api_service.models."""
...
def test_enums_importable():
    """All 3 enum classes can be imported from api_service.models."""
    from api_service.models import AdminRole, AdminStatus, PoolAccountStatus
...
def test_metadata_contains_all_tables():
    ...
    import api_service.models  # noqa: F401 — trigger registration
