...
from api_service.common.core.exceptions import NotFoundException  # noqa: E402
from api_service.core.db import get_db  # noqa: E402
from api_service.main import app  # noqa: E402
from api_service.services.model_catalog_service import (  # noqa: E402
...
async def test_cache_hits():
    ...
    with patch(
        "api_service.common.infra.cache.get_cache_redis",
        return_value=fake_redis,
    ), patch(
        "api_service.services.model_catalog_service.ModelVendorRepository"
    ) as mock_repo_cls:
        mock_repo = MagicMock()
...
@pytest.mark.asyncio
@patch(
    "api_service.controllers.model_catalog.ModelCatalogReadService.list_models",
...
@pytest.mark.asyncio
@patch(
    "api_service.controllers.model_catalog.ModelCatalogReadService.get_model_by_slug",
    new_callable=AsyncMock,
)
