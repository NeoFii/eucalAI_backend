...
@pytest.mark.asyncio
@patch("api_service.core.dependencies.user.decode_token", return_value={"type": "refresh", "uid": "u1"})
...
@pytest.mark.asyncio
@patch("api_service.core.dependencies.user.decode_token", return_value={"type": "access"})
...
@pytest.mark.asyncio
@patch("api_service.core.dependencies.user.UserRepository")
@patch("api_service.core.dependencies.user.decode_token", return_value={"type": "access", "uid": "u_abc"})
...
@pytest.mark.asyncio
@patch("api_service.core.dependencies.user.set_uid")
@patch("api_service.core.dependencies.user.UserRepository")
@patch("api_service.core.dependencies.user.decode_token", return_value={"type": "access", "uid": "u_abc"})
...
@patch("api_service.core.dependencies.user.set_uid")
@patch("api_service.core.dependencies.user.UserRepository")
@patch("api_service.core.dependencies.user.decode_token", return_value={"type": "access", "uid": "u_cookie"})
...
@patch("api_service.core.dependencies.user.set_uid")
@patch("api_service.core.dependencies.user.UserRepository")
@patch("api_service.core.dependencies.user.decode_token", return_value={"type": "access", "uid": "u1"})
async def test_get_current_user_no_blacklist_check(mock_decode, mock_repo_cls, mock_set_uid):
    ...
    import api_service.core.dependencies.user as user_mod
...
@pytest.mark.asyncio
@patch("api_service.core.dependencies.admin.is_token_blacklisted", new_callable=AsyncMock, return_value=True)
...
@pytest.mark.asyncio
@patch("api_service.core.dependencies.admin.AdminUserRepository")
@patch("api_service.core.dependencies.admin.decode_token", return_value={"type": "access", "uid": "a_xyz"})
@patch("api_service.core.dependencies.admin.is_token_blacklisted", new_callable=AsyncMock, return_value=False)
...
@pytest.mark.asyncio
@patch("api_service.core.dependencies.admin.set_uid")
@patch("api_service.core.dependencies.admin.AdminUserRepository")
@patch("api_service.core.dependencies.admin.decode_token", return_value={"type": "access", "uid": "a_xyz"})
@patch("api_service.core.dependencies.admin.is_token_blacklisted", new_callable=AsyncMock, return_value=False)
...
@patch("api_service.core.dependencies.admin.set_uid")
@patch("api_service.core.dependencies.admin.AdminUserRepository")
@patch("api_service.core.dependencies.admin.decode_token", return_value={"type": "access", "uid": "a_opt"})
@patch("api_service.core.dependencies.admin.is_token_blacklisted", new_callable=AsyncMock, return_value=False)
