"""Auth schema split for api-service user domain (ported 1:1 from user-service)."""
...
from app.common.utils.email import normalize_email
...
# Backwards-compat alias: plan acceptance lists `RefreshTokenResponse` /
# `RefreshTokenResponseData`. Source uses `RefreshResponse` / `RefreshResponseData`.
# Expose both names so neither downstream call site breaks.
