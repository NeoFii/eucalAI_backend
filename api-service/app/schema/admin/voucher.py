...
Ported from services/admin-service/src/schemas/voucher.py.
Rewrites: AdminBaseResponse -> BaseResponse; import paths -> app.*
"""
...
class GenerateVoucherCodesRequest(BaseModel):
    ...
    def normalize_datetime(cls, value: datetime) -> datetime:
        from app.common.utils.timezone import to_shanghai_naive
    ...
    def validate_window(self):
        ...
        from app.common.utils.timezone import now as tz_now
...
class VoucherCodeCreateResponse(BaseResponse):
    data: VoucherCodeCreateData | None = None


class VoucherCodeResponse(BaseResponse):
    data: VoucherCodeItem | None = None


class VoucherCodeListResponse(BaseResponse):
    data: dict | None = None


class VoucherOperationResponse(BaseResponse):
    pass
