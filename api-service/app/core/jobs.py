...
#   services/api-service/app/schemas/admin/audit_log.py:21 (all 8
...
from app.core.db import close_db, create_engine, get_db_context, init_session_factory
from app.model import EmailVerificationCode
...
async def aggregate_usage_stats(ctx: dict, stat_hour_iso: str | None = None) -> None:
    ...
    del ctx
    from app.service.usage_stat_service import UsageStatService  # lazy — usage_stat_service ships in 04-02
...
async def run_health_checks(ctx: dict) -> None:
    ...
    from app.service.admin.health_check_service import HealthCheckService
