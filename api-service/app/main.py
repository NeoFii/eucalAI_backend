...
from app.common.core.exception_handlers import register_exception_handlers
from app.relay.rate_limiter import RateLimitExceeded
from app.common.observability import (
    configure_logging_from_settings,
    install_observability,
    log_event,
)
from app.common.utils.snowflake import configure_snowflake
from app.core.config import settings
from app.core.lifespan import LifespanRegistry
...
async def _init_database() -> None:
    ...
    from app.core.db import create_engine, init_session_factory
...
async def _bootstrap_super_admin() -> None:
    ...
    a live DB session.
    """
    from app.service.admin.bootstrap_service import AdminBootstrapService
...
async def _init_redis() -> None:
    ...
    from app.common.infra.redis import init_redis
...
async def _shutdown_redis() -> None:
    ...
    from app.common.infra.redis import close_redis
...
async def _init_cache_redis() -> None:
    ...
    from app.common.infra.cache import init_cache_redis
...
async def _shutdown_cache_redis() -> None:
    ...
    from app.common.infra.cache import close_cache_redis
...
from app.controller.relay import relay_router  # noqa: E402
...
async def ready():
    ...
    from app.common.health import build_readiness_response, check_database_ready
    from app.common.infra.cache import check_cache_redis_ready
    from app.common.infra.redis import check_redis_ready
