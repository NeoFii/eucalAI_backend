...
# Plan 05-01:
from app.controller.admin import auth as _admin_auth  # noqa: E402
...
from app.controller.admin import pools as _admin_pools  # noqa: E402

admin_router.include_router(_admin_pools.router)

from app.controller.admin import model_catalog as _admin_model_catalog  # noqa: E402
from app.controller.admin import routing_settings as _admin_routing_settings  # noqa: E402
from app.controller.admin import admin_users as _admin_admin_users  # noqa: E402
from app.controller.admin import audit_logs as _admin_audit_logs  # noqa: E402
...
from app.controller.admin import users as _admin_users  # noqa: E402

admin_router.include_router(_admin_users.router)

from app.controller.admin import dashboard as _admin_dashboard  # noqa: E402
from app.controller.admin import vouchers as _admin_vouchers  # noqa: E402
from app.controller.admin import route_monitor as _admin_route_monitor  # noqa: E402
...
from app.controller.admin import service_logs as _admin_service_logs  # noqa: E402
