...
from app.service.admin.admin_user_service import AdminEndUserService
...
async def get_user_detail(
    ...
    from app.service.admin.admin_user_service import _UserNotFound
