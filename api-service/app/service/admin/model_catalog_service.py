...
- Standard import rewrites (`from models` → `from app.model`,
  `from repositories` → `from app.repository.model_catalog_repository`,
  `from services.audit_service` → `from app.service.admin.audit_service`,
  `from schemas.model_catalog` → `from app.schema.admin.model_catalog`,
  `from common.core.exceptions` → `from app.common.core.exceptions`).
