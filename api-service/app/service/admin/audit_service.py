...
`common.request_context`) are rewritten to their app namespace
...
from app.model import AdminAuditLog, AuditActionDefinition
...
from app.schema.admin.audit_log import AdminAuditCategory
...
class AdminAuditService:
    ...
    async def record_auto(
        ...
        *,
        ...
        from app.common.http.request_context import (
            get_request_ip,
