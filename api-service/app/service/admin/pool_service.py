...
- `from core.enums import PoolAccountStatus` → `from app.model.enums import PoolAccountStatus`
...
- `from schemas.pool import (...)` → `from app.schema.admin.pool import (...)`
...
- `from common.utils.crypto import ...` →
  `from app.common.security.crypto import ...`
...
class PoolService:
    ...
    async def remove_pool_model(
        ...
        *,
        ...
        from app.repository.routing_setting_repository import (
