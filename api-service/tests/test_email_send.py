...
# Settings must be configured before importing app.* (BaseServiceSettings
...
@pytest.mark.asyncio
@patch("app.service.email_service.get_arq_pool")
...
@pytest.mark.asyncio
@patch("app.service.email_service.hash_password_async", new_callable=AsyncMock)
@patch("app.service.email_service.get_arq_pool")
@patch("app.service.email_service.UserRepository")
