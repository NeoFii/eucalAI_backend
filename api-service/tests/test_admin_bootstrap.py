...
async def test_first_time_create(mock_db):
    ...
    with (
        patch(
            "app.service.admin.bootstrap_service.get_db_context",
            return_value=_stub_db_context(mock_db),
        ),
        patch(
            "app.service.admin.bootstrap_service.AdminUserRepository",
            return_value=repo,
        ),
        patch(
            "app.service.admin.bootstrap_service.AdminAuditService.record",
            new=audit_record,
        ),
        patch(
            "app.service.admin.bootstrap_service.hash_password_async",
            new=AsyncMock(return_value="hashed-password"),
        ),
        patch(
            "app.service.admin.bootstrap_service.check_password_strength",
            return_value=(True, ""),
        ),
        patch(
            "app.service.admin.bootstrap_service.generate_nanoid_uid",
            return_value="adm_BOOT01",
        ),
        patch(
            "app.service.admin.bootstrap_service.settings",
