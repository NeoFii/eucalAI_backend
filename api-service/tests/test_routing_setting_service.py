...
from app.common.core.exceptions import ValidationException  # noqa: E402
from app.service.admin.routing_setting_service import (  # noqa: E402
...
async def test_resolve_for_internal_returns_expected_keys():
    ...
    with patch(
        "app.service.admin.routing_setting_service.RoutingSettingRepository"
    ) as MockRepo:
...
async def test_bump_version_increments_redis():
    ...
    with patch(
        "app.service.admin.routing_setting_service.get_cache_redis",
...
async def test_validate_rejects_unavailable():
    ...
    with patch(
        "app.repository.pool_repository.PoolRepository",
...
async def test_validate_rejects_no_routing_slug():
    ...
    with patch(
        ...
        "app.repository.model_catalog_repository.ModelCatalogRepository",
