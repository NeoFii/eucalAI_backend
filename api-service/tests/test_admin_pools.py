...
from app.model.enums import PoolAccountStatus  # noqa: E402
from app.schema.admin.pool import (  # noqa: E402
    PoolAccountCreate,
    PoolModelCreate,
)
from app.service.admin.pool_service import PoolService  # noqa: E402
...
async def test_create_encrypts_key(mock_super_admin):
    ...
    with patch(
        "app.service.admin.pool_service.PoolRepository",
        return_value=repo_mock,
    ), patch(
        "app.service.admin.pool_service.encrypt_api_key",
        return_value=sentinel_ciphertext,
    ) as enc_mock, patch(
        "app.service.admin.pool_service.mask_api_key",
        return_value="sk-l****-key",
    ), patch(
        "app.service.admin.pool_service.AdminAuditService.record_auto",
...
async def test_check_balances(mock_super_admin):
    ...
    with patch(
        ...
        "app.service.admin.pool_service.decrypt_api_key",
        return_value="sk-decrypted-key",
    ) as dec_mock, patch(
        "app.service.admin.pool_service.get_internal_client",
