...
from app.common.core.exceptions import InvalidCodeException  # noqa: E402
from app.common.utils.timezone import now  # noqa: E402
...
@pytest.mark.asyncio
@patch("app.service.email_service.verify_password_async", new_callable=AsyncMock)
@patch("app.service.email_service.UserRepository")
