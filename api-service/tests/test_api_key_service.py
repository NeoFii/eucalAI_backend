...
from app.model import UserApiKey  # noqa: E402
from app.service.api_key_service import ApiKeyService  # noqa: E402


@pytest.mark.asyncio
@patch("app.service.api_key_service.ApiKeyRepository")
