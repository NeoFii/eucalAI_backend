...
from app.model import BalanceTransaction, VoucherRedemptionCode  # noqa: E402
from app.service.voucher_service import VoucherService  # noqa: E402
...
async def test_redeem_idempotent():
    ...
    with patch(
        "app.service.voucher_service.VoucherRepository"
    ) as mock_voucher_cls, patch(
        "app.service.voucher_service.UserRepository"
    ) as mock_user_cls, patch(
        "app.service.voucher_service.BillingRepository"
    ) as mock_billing_cls:
