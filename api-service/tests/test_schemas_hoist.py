...
Task 1a behaviors (1-4):
    1. `from app.common.schemas import ...` resolves; legacy
       `AuthBaseResponse` removed from `app.schema.common`.
...
def test_phase4_imports_rewritten() -> None:
    ...
    with pytest.raises(ImportError):
        from app.schema.common import AuthBaseResponse  # noqa: F401
...
def test_datetime_model_uses_list_wrap() -> None:
    ...
    import app.common.schemas as schemas_mod
...
def test_internal_sender_imports_resolve() -> None:
    """Behavior 5 — HMAC sender exports importable from `app.common.internal`."""
    from app.common.internal import (  # noqa: F401
...
def test_signing_primitives_shared() -> None:
    ...
    """
    from app.common.http import internal_auth, internal_signing
    from app.common import internal as internal_sender
