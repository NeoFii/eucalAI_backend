...
Plans:
- [ ] 02-01: SQLAlchemy async engine and session factory
- [ ] 02-02: Redis connection pools (3 logical DBs)
...
Plans:
- [ ] 03-01: ORM models consolidation
- [ ] 03-02: Repository layer migration
...
Plans:
- [ ] 04-01: User auth controllers (register/login/logout/refresh)
- [ ] 04-02: API Key and billing controllers
- [ ] 04-03: Model catalog and email service
...
| 2. Database & Redis Infrastructure | 0/4 | Planned | - |
