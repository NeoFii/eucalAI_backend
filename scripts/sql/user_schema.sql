...
CREATE TABLE IF NOT EXISTS `api_call_logs` (
    ...
    `status` TINYINT NOT NULL DEFAULT 0 COMMENT '0=pending 1=success 2=error 3=refunded 4=aborted',
    ...
    `config_source` VARCHAR(32) NULL COMMENT 'Config source (admin/local)',
